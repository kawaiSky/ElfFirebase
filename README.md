...
<root>
  ...
  ├── Editor
  │   ├── Undefined.Firebase.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Undefined.Firebase.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Undefined.Firebase.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Undefined.Firebase.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Undefined.Firebase`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package firebase Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Undefined.Firebase.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Undefined.Firebase.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Undefined.Firebase.Editor.Tests.asmdef`

  `Tests/Runtime/Undefined.Firebase.Tests.asmdef`
...
Use the `Documentations~/firebase.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
